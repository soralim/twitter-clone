...
export default function AuthPage() {
    ...
    const url = "https://4d53feb2-b69c-460a-9c1e-fbfe11749a6a-00-1mw8o1m4u90ev.pike.replit.dev";
            ...
            <Col sm={6} className='p-4'>
                ...
                <Col sm={5} className='d-grid gap-2'>
                    ...
                    <p style={{ fontSize: "12px" }}>
                        By signing up, you agree to the terms of services and privacy pilocy including cookie use
                    </p>
                ...
                <Modal.Body>
                    ...
                    <Form className='d-grid gap-2 px-5' onSubmit={modalShow === "SignUp" ? handleSignUp : handleLogin}>
                        ...
                        <p style={{ fontSize: "12px" }}>
                            ...
                            like keeping your account seceure and personalising our services, including ads.
